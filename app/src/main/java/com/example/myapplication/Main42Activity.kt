...
class Main42Activity : AppCompatActivity() {
    ...
    fun skip(view: View) {
        ...
        if(score>=14){
            when (cd.id) {
                bu1.id -> {
                    var intent= Intent(this@Main42Activity,Main42Activity::class.java)
                ...
                bu3.id -> { var intent= Intent(this@Main42Activity,Main42Activity::class.java)
                    startActivity(intent)
                }
                bu4.id -> {var intent= Intent(this@Main42Activity,Main51Activity::class.java)
                    startActivity(intent)
                }
            }
        }
