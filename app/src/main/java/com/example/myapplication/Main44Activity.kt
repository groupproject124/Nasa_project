...
class Main44Activity : AppCompatActivity() {
    ...
    fun skip(view: View) {
        ...
        if(score>=24){
            when (cd.id) {
                bu1.id -> {
                    var intent= Intent(this@Main44Activity,Main44Activity::class.java)
                ...
                bu3.id -> { var intent= Intent(this@Main44Activity,Main48Activity::class.java)
                    startActivity(intent)
                    score++
                }
                bu4.id -> {var intent= Intent(this@Main44Activity,Main44Activity::class.java)
                    startActivity(intent)
                }
            }
        }
