...
class Main41Activity : AppCompatActivity() {
    ...
    fun skip(view: View) {
        ...
        if(score==24){
            when (cd.id) {
                bu1.id -> {
                    var intent= Intent(this@Main41Activity,Main41Activity::class.java)
                ...
                bu3.id -> { var intent= Intent(this@Main41Activity,Main41Activity::class.java)
                    startActivity(intent)
                }
                bu4.id -> {var intent= Intent(this@Main41Activity,Main51Activity::class.java)
                    startActivity(intent)
                    score++
                }
            }
